...
const AuthorityList = (props) => {
    ...
    const exportToCsv = e => {
        ...
        let headers = ['Id,AuthorityName,CreatedAt']
                ...
                <div className="bodyright">
                    ...
                    <div className="white_box_shadow_20 survivors_table_wrap vieweditdeleteMargin40 position-relative">
                        ...
                        <AuthorityListDataTable 
                            authorityList={authorityList && authorityList.data && authorityList.data.length > 0 && authorityList.data}
                        ...
                        <div className="site_form_wraper">
                            <Form>
                                ...
                                <Row className="justify-content-between">
                                    ...
                                    <Form.Group as={Col} md="auto">
                                        <Button type="submit"
                                        disabled={addShgData && !addShgData.name ? true  : !addShgData.authority_type ? true  : false}
                                            onClick={addShgFunc}
