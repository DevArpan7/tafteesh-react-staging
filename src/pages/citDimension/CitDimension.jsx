...
import {getCitDimensionList,deleteCitDimension} from '../../redux/action';
                ...
                <div className="bodyright">
                    ...
                    <div className="white_box_shadow_20 survivors_table_wrap vieweditdeleteMargin40 position-relative">
                        ...
                        <CitDimensionDataTable
                            citDimensionList={citDimensionList && citDimensionList.length > 0 && citDimensionList}
                        ...
                        {/* <div className="table-responsive">
                            <table className="table table-borderless mb-0">
                                ...
                                <tbody>
                                    {citDimensionList && citDimensionList.length > 0 ? citDimensionList.map((item) => {
                                        return (
