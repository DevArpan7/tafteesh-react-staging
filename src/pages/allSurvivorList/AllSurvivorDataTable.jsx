...
const AllSurvivortDataTable = (props) => {
  ...
  const { allsurvivorList, onSelectRow,isLoading,handleChange } = props;
  ...
  const dateBodyTemplate = (rowData) => {
    return formatDate(rowData.date_of_birth && rowData.date_of_birth);
  };


  const traffickingDateBodyTemplate =(rowData)=>{
    return formatDate(rowData.date_of_trafficking && rowData.date_of_trafficking);
