...
import { getShgList ,deleteShg} from '../../redux/action';
...
import ShgDataTable from './ShgDataTable';
...
const onDeleteChangeFunc=()=>{
  ...
  const onDeleteFunction=()=>{
    dispatch(deleteShg(selectedData._id))
    setShowAlert(false)
  }
    ...
    const exportToCsv = e => {
        ...
        let headers = ['Id,SHGName,CreatedAt']

        // Convert users data to a csv
        let usersCsv = shgList.data.reduce((acc, user) => {
                ...
                <div className="bodyright">
                    <div className="row justify-content-between">
                        <div className="col-auto">
                            <h2 className="page_title">SHG List</h2>
                        </div>
                    </div>
                    <div className="white_box_shadow_20 survivors_table_wrap vieweditdeleteMargin40 position-relative">
                        ...
                        <ShgDataTable 
                            shgList={shgList && shgList.data && shgList.data.length > 0 && shgList.data}
                        ...
                        {/* <div className="table-responsive">
                            <table className="table table-borderless mb-0">
                                ...
                                <tbody>
                                    {shgList && shgList.data && shgList.data.length > 0 ? shgList.data.map((item) => {
                                        return (
