...
const CitDimensionQuesDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { citDimensionQuestionList, onSelectRow ,isLoading} = props;
  ...
  const customerService =
    citDimensionQuestionList && citDimensionQuestionList.length > 0 && citDimensionQuestionList;
  ...
  const traffickerNameBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.cit_dimension.name}`}>
        {rowData.cit_dimension.name}
      </span>
    );
  };
  ...
  const survivorCountBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.data_existance_check  === true
        ? "Yes"
        : "No"}`}>
        {rowData.data_existance_check  === true
                              ? "Yes"
                              : "No"}
      </span>
    );
  ...
  return (
    <div className="dataTableFilter">
        ...
        >
          ...
          /> */}
            <Column
            header="CIT Dimension"
            // dataType="date"
            filterField="cit_dimension"
        ...
        <Column
            header="Question Existance Check"
            // dataType="date"
            filterField="data_existance_check"
            style={{ minWidth: "18rem" }}
        ...
        <Column
            header="Question Existance Check From"
            // dataType="date"
            filterField="data_existance_check_from"
...
export default CitDimensionQuesDataTable;
