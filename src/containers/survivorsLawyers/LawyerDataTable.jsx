...
const LawyerDataTable = (props) => {
  ...
  const tenureBodyTemplate = (rowData) => {
    return (
      <span className={`customer-badge status-${rowData.leading_at.toUpperCase()}`}>
        {rowData.leading_at.toUpperCase()}
      </span>
    );
  };
  ...
  const purposeBodyTemplate = (rowData) => {
    return (
      <span className={`customer-badge status-${rowData.isleading === true ? "Yes" : "No"}`}>
        {rowData.isleading === true ? "Yes" : "No"}
      </span>
    );
  };
  ...
  const amountBodyTemplate = (rowData) => {
    return (
      <span className={`customer-badge status-${rowData.name && rowData.name.name}`}>
        {rowData.name && rowData.name.name}
      </span>
    );
  };
  ...
  const rateBodyTemplate = (rowData) => {
    return (
      <span className={`customer-badge status-${rowData.type && rowData.type.name}`}>
