...
const AuthorityTypeDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { authorityTypeList, onSelectRow,isLoading } = props;
  ...
  const customerService =
    authorityTypeList && authorityTypeList.length > 0 && authorityTypeList;
...
export default AuthorityTypeDataTable;
