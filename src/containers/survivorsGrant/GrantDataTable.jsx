...
const GrantDataTable = (props) => {
  ...
  const { survivalGrantList, onSelectRow, survivorName,isLoading } = props;
  ...
  const sourceBodyTemplate = (rowData) => {
    ...
    return (
      <React.Fragment>
        ...
        <span className="image-text">{rowData.name_of_grant_compensation &&rowData.name_of_grant_compensation.name }</span>
      </React.Fragment>
    );
  };
  ...
  return (
    <div className="dataTableFilter">
        ...
        >
          ...
          <Column
            header="Name"
            filterField="name_of_grant_compensation"
