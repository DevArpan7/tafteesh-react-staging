...
const UserListDataTableList = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { usersList, onSelectRow ,isLoading} = props;
  ...
  const addressBodyTemplate = (rowData) => {
    return (
      <span className={`customer-badge status-${rowData.mobile}`}>
        {rowData.mobile}
      </span>
    );
  };
  ...
  const traffickerNameBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.role.name}`}>
        {rowData.role.name}
      </span>
    );
  };
  ...
  const isTraffickerBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.organization && rowData.organization.name}`}>
        {rowData.organization && rowData.organization.name}
      </span>
    );
  };
  ...
  const idMarkBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.userNo}`}>
        {rowData.userNo}
      </span>
    );
  };
...
export default UserListDataTableList;
