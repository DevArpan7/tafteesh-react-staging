...
const FirDataTable = (props) => {
  ...
  const policeStationBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.policeStation && rowData.policeStation.name}`}>
        {rowData.policeStation &&rowData.policeStation.name}
      </span>
    );
  };
