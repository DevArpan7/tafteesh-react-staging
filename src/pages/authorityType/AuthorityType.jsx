...
const AuthorityType = (props) => {
    ...
    const api = "https://kamo-api.herokuapp.com/api/authority_type";
    ...
    const onDeleteChangeFunc = () => {
        if (selectedData && !selectedData._id) {
          alert("Please select one Authority Type");
        } else {
          setShowAlert(true);
        }
      };
    ...
    const exportToCsv = e => {
        ...
        let headers = ['Id,AuthorityTypeName,CreatedAt']
        ...
        <>
            ...
            <main className="main_body">
                ...
                <div className="bodyright">
                    ...
                    <div className="white_box_shadow_20 survivors_table_wrap vieweditdeleteMargin40 position-relative">
                        ...
                        <AuthorityTypeDataTable 
                            authorityTypeList={authorityTypeList && authorityTypeList.length > 0 && authorityTypeList}
                ...
                <Modal className="addFormModal" show={modalAddShow} onHide={setModalAddShow} size="lg" aria-labelledby="reason-modal" centered>
                    <Modal.Header closeButton>
                        <Modal.Title id="contained-modal-title-vcenter">
                        {addShgData && addShgData._id ? "Update Authority Type" : "Add Authority Type"}
                        </Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div className="site_form_wraper">
