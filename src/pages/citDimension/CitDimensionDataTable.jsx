...
const CitDimensionDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { citDimensionList, onSelectRow ,isLoading} = props;
  ...
  const customerService =
    citDimensionList && citDimensionList.length > 0 && citDimensionList;
...
export default CitDimensionDataTable;