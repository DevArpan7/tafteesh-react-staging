...
const LawyerCategoryDataTable = (props) => {
  const [customers1, setCustomers1] = useState([]);
  const [filters1, setFilters1] = useState(null);
  const { lawyersCategoryList, onSelectRow ,isLoading} = props;
  ...
  const customerService =
    lawyersCategoryList && lawyersCategoryList.length > 0 && lawyersCategoryList;
...
export default LawyerCategoryDataTable;