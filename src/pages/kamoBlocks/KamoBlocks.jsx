...
import { getMasterBlockList, getStateList, getDistrictList } from '../../redux/action';
...
const KamoBlocks = (props) => {
  ...
  const exportToCsv = e => {
    ...
    const [sampleArr , setSampleArr] = useState([{"name":"Andal", "stateId":"62a9a7c3c05c6a1059f92eb0","districtId": "62a9e0bd700081c79aaf47e6"}])
    ...
    useEffect(() => {
        ...
        importCSVdata && importCSVdata.length > 0 && importCSVdata.map((item) => {
            return (
                obj = { name :item && item.Block,stateId :item && item.State,
            ...
            <main className="main_body">
                ...
                <div className="bodyright">
                    ...
                    <div className="white_box_shadow_20 survivors_table_wrap vieweditdeleteMargin40 position-relative">
                        ...
                        <BlocksDataTable 
                            masterBlockList={masterBlockList && masterBlockList.length > 0 && masterBlockList}
                                    ...
                                    <Form.Group as={Col} md="auto">
                                        <Button type="submit"
                                            disabled={addBlockData && !addBlockData.name ? true : !addBlockData.stateId ? true :
                                                !addBlockData.districtId ? true : false}
