...
const LawyersListDataTable = (props) => {
  ...
  const categoryBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.name_of_group.name}`}>
        {rowData.name_of_group.name}
      </span>
    );
  };
  ...
  const blockIdBodyTemplate = (rowData) => {
    ...
    return (
      <span className={`customer-badge status-${rowData.blockId.name}`}>
        {rowData.blockId.name}
      </span>
    );
  };
